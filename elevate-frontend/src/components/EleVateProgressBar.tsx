...
interface EleVateProgressBarProps {
  min: number;
  max: number;
  value: number;
  goal: number;
...
const EleVateProgressBar: React.FC<EleVateProgressBarProps> = ({ 
  min, 
  max, 
  value, 
  goal, 
  ...
  if (type === 'circle') {
    return (
      <div className="elevate-progress-circle">
  ...
  return (
    <div className="elevate-progress-bar">
...
export default EleVateProgressBar;