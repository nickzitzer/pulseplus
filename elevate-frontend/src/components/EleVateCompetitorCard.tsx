...
import EleVateProgressBar from './EleVateProgressBar';
import EleVateLeagueStandings from './EleVateLeagueStandings';
import EleVateBadges from './EleVateBadges';
import EleVateKPIs from './EleVateKPIs';
...
interface EleVateCompetitorCardProps {
  competitorId: string;
  gameId: string;
  onClose: () => void;
}

const EleVateCompetitorCard: React.FC<EleVateCompetitorCardProps> = ({ competitorId, gameId, onClose }) => {
        ...
        <div className="mt-20 p-6">
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 max-h-64 overflow-y-auto">
              {activeTab === 'league_standings' && <EleVateLeagueStandings gameId={gameId} />}
              {activeTab === 'stats' && <EleVateKPIs gameId={gameId} />}
              {activeTab === 'badges' && <EleVateBadges gameId={gameId} />}
            </div>
          </div>
        </div>
      </div>
...
export default EleVateCompetitorCard;