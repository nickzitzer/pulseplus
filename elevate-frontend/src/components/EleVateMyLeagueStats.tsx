...
interface EleVateMyLeagueStatsProps {
  gameId: string;
  competitorId: string;
}

const EleVateMyLeagueStats: React.FC<EleVateMyLeagueStatsProps> = ({ gameId, competitorId }) => {
...
export default EleVateMyLeagueStats;