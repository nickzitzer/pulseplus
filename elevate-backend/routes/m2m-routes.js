...
router.use('/badge-competitor', createCRUD('x_tusk_elevate_m2m_badges_competitors'));
router.use('/achievement-competitor', createCRUD('x_tusk_elevate_m2m_achievements_competitors'));
router.use('/team-competition', createCRUD('x_tusk_elevate_m2m_teams_competitions'));
