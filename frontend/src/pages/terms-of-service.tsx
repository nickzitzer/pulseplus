 ...
 * Key Components: Complete terms, Privacy policy, Data usage info, Acceptance tracking
 */
const TermsOfServicePage = () => {
  ...
  return (
    <>
      <Head>
        <title>Terms of Service | PulsePlus</title>
      </Head>
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mt-8">
          <Link href="/login" className="text-sky-400 hover:text-sky-800">
            Back to Login
          </Link>
        </div>
      </div>
