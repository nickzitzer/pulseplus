      ...
      {isOpen && (
        <div className="bg-white shadow-lg rounded-lg w-80 h-96 flex flex-col mb-4">
          <div className="bg-sky-400 text-white p-4 rounded-t-lg flex justify-between items-center">
            ...
            {activeGroup && (
              <button onClick={() => setActiveGroup(null)} className="text-white" aria-label="Back to chat list">
                <ChevronLeft size={24} />
              </button>
            )}
          </div>
            ...
            <>
              ...
              <div className="p-4 border-t">
                <div className="flex">
                  ...
                  />
                  <button onClick={handleSendMessage} className="bg-sky-400 text-white p-2 rounded-r-lg" aria-label="Send message">
                    <Send size={20} />
                  </button>
                </div>
              </div>
