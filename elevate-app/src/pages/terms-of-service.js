    ...
    <PublicPage>
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="prose max-w-none">
          <p>Welcome to EleVate. By using our service, you agree to these terms.</p>
          
          <h2 className="text-2xl font-semibold mt-6 mb-4">1. Acceptance of Terms</h2>
          <p>By accessing or using the EleVate platform, you agree to be bound by these Terms of Service and all applicable laws and regulations.</p>
          
          <h2 className="text-2xl font-semibold mt-6 mb-4">2. Use of Service</h2>
          <p>You agree to use EleVate only for lawful purposes and in accordance with these Terms of Service.</p>
          
          <h2 className="text-2xl font-semibold mt-6 mb-4">3. User Accounts</h2>
          <p>To access certain features of EleVate, you may be required to create an account. You are responsible for maintaining the confidentiality of your account information.</p>
          
          <h2 className="text-2xl font-semibold mt-6 mb-4">4. Privacy</h2>
          <p>Your use of EleVate is also governed by our Privacy Policy, which can be found [link to privacy policy].</p>
