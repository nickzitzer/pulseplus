...
const EleVateTimer: React.FC<TimerProps> = ({ deadlineTimestamp, eventId, color = 'rgba(31, 30, 34, .8)' }) => {
  ...
  return (
    <div className="elevate-timer" style={{ backgroundColor: color, padding: '10px', borderRadius: '8px' }}>
