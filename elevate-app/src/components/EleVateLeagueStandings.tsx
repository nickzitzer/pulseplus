...
interface EleVateLeagueStandingsProps {
...
const EleVateLeagueStandings: React.FC<EleVateLeagueStandingsProps> = ({ gameId }) => {
  ...
  return (
    <div className="elevate-league-standings">
...
export default EleVateLeagueStandings;