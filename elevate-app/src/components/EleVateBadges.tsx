...
interface EleVateBadgesProps {
  gameId: string | undefined;
}

const EleVateBadges: React.FC<EleVateBadgesProps> = ({ gameId }) => {
  ...
  return (
    <div className="elevate-badge-container">
