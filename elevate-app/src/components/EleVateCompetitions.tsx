...
interface EleVateCompetitionsProps {
...
const EleVateCompetitions: React.FC<EleVateCompetitionsProps> = ({ gameId }) => {
  ...
  return (
    <div className="elevate-competitions grid grid-cols-1 md:grid-cols-2 gap-4">
...
export default EleVateCompetitions;